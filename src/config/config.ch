...
client:
    ...
    test_mode=false                                                                                                         # true if you want to run tests false if you want to run the client
    test_dir=C:\Projects\TestGame\TestGameServer\src\client\test\tests\tests.t                                              # file to run tests from
